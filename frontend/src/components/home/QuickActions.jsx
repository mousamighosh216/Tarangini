export default function QuickActions({ onNavigate, isMobile }) {
  const actions = [
    {
      icon: (
  ...
  return (
    <div style={{
      ...
      {/* Log Symptoms CTA - spans full width on mobile */}
      <button
        ...
        style={{
          ...
          padding: isMobile ? "16px" : "20px", color: "#fff", textAlign: "center",
      ...
      >
        ...
        <div style={{ fontWeight: "600", fontSize: isMobile ? "14px" : "15px" }}>Log Today's Symptoms</div>
      ...
      {actions.map((action, i) => (
        <button
          ...
          style={{
            ...
            padding: isMobile ? "12px" : "16px", cursor: "pointer",
            textAlign: "left",
            display: "flex",
        ...
        >
          ...
          <div>
            <div style={{ fontWeight: "600", fontSize: isMobile ? "13px" : "14px", color: "#333" }}>
              {action.label}
            </div>
            <div style={{ fontSize: "12px", color: "#aaa", marginTop: "2px", lineHeight: 1.3 }}>
              {action.sublabel}
            </div>
          </div>
        </button>
      ...
      {/* Today's Tip - spans full width on mobile */}
      <div style={{
        gridColumn: isMobile ? "1 / -1" : "auto",
