  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "6px" }}>
        <div>
          <h2 style={{ margin: 0, fontSize: isMobile ? "16px" : "18px", fontWeight: "600", color: "#333" }}>
            Current Cycle Phase
          </h2>
      ...
      {/* Ovulation Window */}
      <div style={{
        background: "#f0eeff", borderRadius: "12px", padding: "16px", marginBottom: "16px",
      }}>
      ...
      <div style={{
        ...
        <div style={{
          background: "#fff5f5", borderRadius: "12px", padding: isMobile ? "12px" : "16px",
          border: "1px solid #fde8e8",
        }}>
          <p style={{ margin: "0 0 8px", fontSize: "12px", color: "#aaa" }}>Next period in</p>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <div>
              <span style={{ fontSize: isMobile ? "24px" : "28px", fontWeight: "700", color: "#e8928f" }}>
                {daysUntilPeriod}
              </span>
        ...
        <div style={{
          background: "#f5f0ff", borderRadius: "12px", padding: isMobile ? "12px" : "16px",
          border: "1px solid #ede8ff",
        }}>
          <p style={{ margin: "0 0 8px", fontSize: "12px", color: "#aaa" }}>Cycle regularity</p>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <div>
              <span style={{ fontSize: isMobile ? "24px" : "28px", fontWeight: "700", color: "#9d8fd6" }}>
                94%
              </span>
